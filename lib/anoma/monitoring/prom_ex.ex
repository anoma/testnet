defmodule Anoma.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule AnomaWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :anoma
  ...
  def dashboard_assigns do
    [
      datasource_id: "anoma_testnet_prom",
  ...
  def dashboards do
    [
      ...
      # {:anoma, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
